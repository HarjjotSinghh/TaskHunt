                    ...
                    <div className="flex items-center lg:order-2">
                        <div className="relative">
                            {user ? (
                                <button
                                    type="button"
                                    className="flex lg:pl-16 pl-0 lg:mr-3 items-center justify-center text-sm  rounded-full mr-0"
                                    id="user-menu-button"
                                    aria-expanded="false"
                                ...
                                <Link
                                    ...
                                    <h1 className="pt-1">Login</h1>
                                    <img
                                        className="xl:w-6 xl:h-6 w-5 h-5"
                                        draggable="false"
                                        src="https://cdn-icons-png.flaticon.com/512/3596/3596092.png"
                                        alt="login"></img>
                                </Link>
                            )}
                            {isOpen && user && (
                                <div
                                    className="origin-top-right absolute right-0 mt-2 w-48 rounded-md border-b border-gray-500 py-1 ring-1backdrop-blur-lg"
                                    role="menu"
